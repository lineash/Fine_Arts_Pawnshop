...
struct works
{
    ...
    float value, buy_price, sell_price, auction_price;
    bool original = true;
    bool have = false;
};
...
void workEdit(char name[50], char writer[50], float value, bool original)
{
    for(int i = 0; i<50; i++)
    {
    ...
    sprintf(work[workCount].image_inventory, "image_inventory_%d.png", workCount);
    sprintf(work[workCount].image_pawnshop, "image_pawnshop_%d.png", workCount);
    sprintf(work[workCount].image_auction, "image_inventory_%d.png", workCount);
...
{
    sprintf(people[peopleCount].image_pawnshop_idle, "%d_image_pawnshop_idle.png", peopleCount);
    /*
...
{
    char buf[30];
    sprintf(buf, "storyRoom_%d.png", nextRoomNumber);
...
SceneID game_init()
{
    ...
    workEdit(work0, writer0, 100000.0, false);
    
    char work1[50] = "뒤돌아보는 미인";
    char writer1[50] = "히시카와 미로노부";
    workEdit(work1, writer1, 200000.0, false);
    
    char work2[50] = "진주 귀고리를 한 소녀";
    char writer2[50] = "요하네스 페르메이르";
    workEdit(work2, writer2, 300000.0, false);
    
    char work3[50] = "카메하메하 동상";
    char writer3[50] = "하와이 호놀룰루";
    workEdit(work3, writer3, 400000.0, false);
    
    char work4[50] = "생각하는 사람";
    char writer4[50] = "오귀스트 로댕";
    workEdit(work4, writer4, 500000.0, false);
    
    //===================================================================
    //작품 데이터 입력
    char work5[50] = "민중을 이끄는 자유의 여신";
    char writer5[50] = "외젠 들라크루아";
    workEdit(work5, writer5, 1000000.0, true);
    
    char work6[50] = "그랑드자트섬의 일요일 오후";
    char writer6[50] = "조르주 쇠라";
    workEdit(work6, writer6, 1100000.0, true);
    
    char work7[50] = "가나가와 해변의 높은 파도 아래";
    char writer7[50] = "가쓰시카 호쿠사이";
    workEdit(work7, writer7, 800000.0, true);
    
    char work8[50] = "하나의 일부";
    char writer8[50] = "잭슨 폴락";
    workEdit(work8, writer8, 10000000.0, true);
    
    char work9[50] = "병마용 병사";
    char writer9[50] = "중국 시안";
    workEdit(work9, writer9, 10000.0, false);
    
    //===================================================================
    //작품 데이터 입력
    char work10[50] = "별이 빛나는 밤";
    char writer10[50] = "빈센트 반 고흐";
    workEdit(work10, writer10, 10000000.0, true);
    
    char work11[50] = "해바라기";
    char writer11[50] = "빈센트 반 고흐";
    workEdit(work11, writer11, 500000.0, true);
    
    char work12[50] = "모나리자";
    char writer12[50] = "레오나르도 다빈치";
    workEdit(work12, writer12, 67000000.0, true);
    
    char work13[50] = "이삭 줍는 여인들";
    char writer13[50] = "장프랑수아 밀레";
    workEdit(work13, writer13, 6000000.0, true);
    
    char work14[50] = "죽음의 섬";
    char writer14[50] = "아놀드 뵈클린";
    workEdit(work14, writer14, 1800000.0, true);
    
    //===================================================================
    //작품 데이터 입력
    char work15[50] = "사과와 오렌지";
    char writer15[50] = "폴 세잔";
    workEdit(work15, writer15, 2000000.0, true);
    
    char work16[50] = "폴리 베르제르 바";
    char writer16[50] = "에두아르 마네";
    workEdit(work16, writer16, 3500000.0, true);
    
    char work17[50] = "전함 테메레르";
    char writer17[50] = "윌리엄 터너";
    workEdit(work17, writer17, 5000000.0, true);
    
    char work18[50] = "씨 뿌리는 사람";
    char writer18[50] = "장프랑수아 밀레";
    workEdit(work18, writer18, 900000.0, true);
    
    char work19[50] = "피리부는 소년";
    char writer19[50] = "에두아르 마네";
    workEdit(work19, writer19, 2000000.0, true);
    
    //===================================================================
    //작품 데이터 입력
    char work20[50] = "옷 입은 마하";
    char writer20[50] = "프란시스코 고야";
    workEdit(work20, writer20, 8000000.0, true);
    
    char work21[50] = "오필리아";
    char writer21[50] = "존 에버렛 밀레이";
    workEdit(work21, writer21, 3400000.0, true);
    
    char work22[100] = "3대 오타니 오니지 얏코에도베";
    char writer22[50] = "도슈사이샤라쿠";
    workEdit(work22, writer22, 700000.0, true);
    
    char work23[50] = "우주";
    char writer23[50] = "김환기";
    workEdit(work23, writer23, 100000000.0, true);
    
    char work24[50] = "황소";
    char writer24[50] = "이중섭";
    workEdit(work24, writer24, 50000000.0, true);
    /*
    //===================================================================
    //작품 데이터 입력
    char work25[50] = "모나리자";
